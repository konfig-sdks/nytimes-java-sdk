...
public class ListGetByDateResponseResultsBooksInner {
  ...
  public ListGetByDateResponseResultsBooksInner() {
  }

  public ListGetByDateResponseResultsBooksInner title(String title) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner description(String description) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner rank(Integer rank) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner rankLastWeek(Integer rankLastWeek) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner weeksOnList(Integer weeksOnList) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner asterisk(Integer asterisk) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner dagger(Integer dagger) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner primaryIsbn10(String primaryIsbn10) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner primaryIsbn13(String primaryIsbn13) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner publisher(String publisher) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner price(Integer price) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner author(String author) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner contributor(String contributor) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner contributorNote(String contributorNote) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner bookImage(String bookImage) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner amazonProductUrl(String amazonProductUrl) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner ageGroup(String ageGroup) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner bookReviewLink(String bookReviewLink) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner firstChapterLink(String firstChapterLink) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner sundayReviewLink(String sundayReviewLink) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner articleChapterLink(String articleChapterLink) {
  ...
  **/
  ...
  public ListGetByDateResponseResultsBooksInner isbns(List<ListGetBestSellersResponseResultsInnerIsbnsInner> isbns) {
  ...
  public ListGetByDateResponseResultsBooksInner addIsbnsItem(ListGetBestSellersResponseResultsInnerIsbnsInner isbnsItem) {
    if (this.isbns == null) {
  ...
  **/
   ...
   * @return the ListGetByDateResponseResultsBooksInner instance itself
   */
  public ListGetByDateResponseResultsBooksInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListGetByDateResponseResultsBooksInner listGetByDateResponseResultsBooksInner = (ListGetByDateResponseResultsBooksInner) o;
    return Objects.equals(this.title, listGetByDateResponseResultsBooksInner.title) &&
        Objects.equals(this.description, listGetByDateResponseResultsBooksInner.description) &&
        Objects.equals(this.rank, listGetByDateResponseResultsBooksInner.rank) &&
        Objects.equals(this.rankLastWeek, listGetByDateResponseResultsBooksInner.rankLastWeek) &&
        Objects.equals(this.weeksOnList, listGetByDateResponseResultsBooksInner.weeksOnList) &&
        Objects.equals(this.asterisk, listGetByDateResponseResultsBooksInner.asterisk) &&
        Objects.equals(this.dagger, listGetByDateResponseResultsBooksInner.dagger) &&
        Objects.equals(this.primaryIsbn10, listGetByDateResponseResultsBooksInner.primaryIsbn10) &&
        Objects.equals(this.primaryIsbn13, listGetByDateResponseResultsBooksInner.primaryIsbn13) &&
        Objects.equals(this.publisher, listGetByDateResponseResultsBooksInner.publisher) &&
        Objects.equals(this.price, listGetByDateResponseResultsBooksInner.price) &&
        Objects.equals(this.author, listGetByDateResponseResultsBooksInner.author) &&
        Objects.equals(this.contributor, listGetByDateResponseResultsBooksInner.contributor) &&
        Objects.equals(this.contributorNote, listGetByDateResponseResultsBooksInner.contributorNote) &&
        Objects.equals(this.bookImage, listGetByDateResponseResultsBooksInner.bookImage) &&
        Objects.equals(this.amazonProductUrl, listGetByDateResponseResultsBooksInner.amazonProductUrl) &&
        Objects.equals(this.ageGroup, listGetByDateResponseResultsBooksInner.ageGroup) &&
        Objects.equals(this.bookReviewLink, listGetByDateResponseResultsBooksInner.bookReviewLink) &&
        Objects.equals(this.firstChapterLink, listGetByDateResponseResultsBooksInner.firstChapterLink) &&
        Objects.equals(this.sundayReviewLink, listGetByDateResponseResultsBooksInner.sundayReviewLink) &&
        Objects.equals(this.articleChapterLink, listGetByDateResponseResultsBooksInner.articleChapterLink) &&
        Objects.equals(this.isbns, listGetByDateResponseResultsBooksInner.isbns)&&
        Objects.equals(this.additionalProperties, listGetByDateResponseResultsBooksInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, rank, rankLastWeek, weeksOnList, asterisk, dagger, primaryIsbn10, primaryIsbn13, publisher, price, author, contributor, contributorNote, bookImage, amazonProductUrl, ageGroup, bookReviewLink, firstChapterLink, sundayReviewLink, articleChapterLink, isbns, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListGetByDateResponseResultsBooksInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListGetByDateResponseResultsBooksInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListGetByDateResponseResultsBooksInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListGetByDateResponseResultsBooksInner is not found in the empty JSON string", ListGetByDateResponseResultsBooksInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListGetByDateResponseResultsBooksInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListGetByDateResponseResultsBooksInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListGetByDateResponseResultsBooksInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListGetByDateResponseResultsBooksInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListGetByDateResponseResultsBooksInner>() {
           @Override
           public void write(JsonWriter out, ListGetByDateResponseResultsBooksInner value) throws IOException {
           ...
           @Override
           public ListGetByDateResponseResultsBooksInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListGetByDateResponseResultsBooksInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListGetByDateResponseResultsBooksInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListGetByDateResponseResultsBooksInner
  * @throws IOException if the JSON string is invalid with respect to ListGetByDateResponseResultsBooksInner
  */
  public static ListGetByDateResponseResultsBooksInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListGetByDateResponseResultsBooksInner.class);
  }

 /**
  * Convert an instance of ListGetByDateResponseResultsBooksInner to an JSON string
  *
  * @return JSON string
  */
