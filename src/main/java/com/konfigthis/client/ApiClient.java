...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.nytimes.com/svc/books/v3";
    ...
    public String getApiKey() {
        return ((ApiKeyAuth) this.getAuthentication("api-key")).getApiKey();
    }

    public void setApiKey(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("api-key")).setApiKey(apiKey);
    }

    public void setApiKeyPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("api-key")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.nytimes.com/svc/books/v3)
